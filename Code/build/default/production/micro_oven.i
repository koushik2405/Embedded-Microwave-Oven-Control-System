...
void display_power_screen(void);
 ...
 void set_temp(unsigned char key , unsigned char reste_flag);
...
unsigned char pre_heat;
 ...
 void display_modes(void)
 {
     clcd_print("1 Micro", (0x80 + 3));
     clcd_print("2 Grill", (0xC0 + 3));
     clcd_print("3 Convection", (0x90 + 3));
     clcd_print("4 Start", (0xD0 + 3));
